...
public class ItemControllerTest {
    ...
    public void testGetItemsWithPageMarker() {
        ...
        stubFor(get(urlEqualTo("/data/v1/items/show")).willReturn(aResponse()
            .withStatus(200)
            .withHeader("Content-Type", "application/json")
            .withBody(twoItemResponseWithPageMarker)));
    ...
    public void testGetItemsWithQueryParams() {
        ...
        stubFor(get(urlEqualTo("/data/v1/items/show?zoneNames=FACILITY&fromTime=2016-07-20T17%3A00%3A00Z&pageSize=3&presenceConfidence=HIGH&facility=NEWFAC&epcFormat=PURE_ID&toTime=2016-07-20T18%3A01%3A00Z&epcPrefix=30")).willReturn(aResponse()
            .withStatus(200)
            .withHeader("Content-Type", "application/json")
    ...
    public void getAllItemsWithEpcFormat() {
        ...
        stubFor(get(urlEqualTo("/data/v1/items/show?pageSize=1000&epcFormat=TAG")).willReturn(aResponse()
            .withStatus(200)
            .withHeader("Content-Type", "application/json")
            .withBody(threeItemResponse)));
    ...
    public void getAllItemsWithMultiplePages() {
        ...
        stubFor(get(urlEqualTo("/data/v1/items/show?pageMarker=UD41zBHH76BqmMdukctbvJvdE9oXQAxPyh6Jw5BjojLdR1paQrVDHN6%2Fhja1TGaR&pageSize=1000")).willReturn(aResponse()
            .withStatus(200)
            .withHeader("Content-Type", "application/json")
            .withBody(lastItem)));
    ...
    public void testGetAllItemsWithQueryParamsWithoutTimes() {
        String threeItemResponse = "{\"items\":" +
            ...
            stubFor(get(urlEqualTo("/data/v1/items/show?zoneNames=ZONE1%2CZONE2&pageSize=1000&presenceConfidence=HIGH&facility=NEWFAC&epcFormat=TAG&epcPrefix=96")).willReturn(aResponse()
            .withStatus(200)
            .withHeader("Content-Type", "application/json")
            .withBody(threeItemResponse)));
